...
router.get('/', async (req, res) => {
    try {
        ...
        let articles;
        // ⚡ Bolt: Removed unnecessary query. Now we only run the query we actually need.
        // Added .lean() to bypass Mongoose document instantiation and directly return raw JSON, improving read performance.
...
router.get('/:slug', async (req, res) => {
    try {
        // ⚡ Bolt: Added .lean() to bypass Mongoose document instantiation for read-only operations
