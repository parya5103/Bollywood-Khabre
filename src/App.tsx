...
export default function App() {
  ...
  const [debouncedSearchQuery, setDebouncedSearchQuery] = useState(""); // ⚡ Bolt: Added debounced state
  ...
  // ⚡ Bolt: Debounce search input to prevent unnecessary API calls while typing
  useEffect(() => {
  ...
  }, [view, debouncedSearchQuery]); // ⚡ Bolt: Depend on debouncedSearchQuery instead of searchQuery
  ...
  const fetchNews = async () => {
    ...
    try {
      ...
      // ⚡ Bolt: Fetch uses the debounced search query
