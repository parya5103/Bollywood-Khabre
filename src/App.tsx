...
export default function App() {
  ...
  // ⚡ Bolt: Debounce search query to prevent unnecessary API calls on every keystroke
  ...
  // ⚡ Bolt: Update debounced state after a delay
  useEffect(() => {
  ...
  const fetchNews = async () => {
    ...
    try {
      ...
      // ⚡ Bolt: Use debouncedSearchQuery in API request
