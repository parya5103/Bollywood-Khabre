...
export default function App() {
  ...
  // ⚡ Bolt Performance Optimization: Debounce search input to reduce API calls
  // Expected Impact: Significantly reduces network requests and re-renders when typing
  useEffect(() => {
