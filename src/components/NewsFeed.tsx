...
export default function NewsFeed({ news, loading, onArticleClick, favorites, onFavoriteToggle, systemHealth }: Props) {
  ...
  return (
    <div className="space-y-24 pb-20">
      ...
      {featured && (
        <section 
          className="relative group grid grid-cols-1 lg:grid-cols-12 gap-0 overflow-hidden rounded-[3rem] border border-white/10 shadow-black shadow-2xl hover:border-orange-500/30 transition-all duration-700"
        >
            ...
            <div className="mb-10">
              ...
              <h2>
                <button
                  ...
                  className="text-left before:absolute before:inset-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent rounded-sm text-5xl md:text-6xl font-black text-white leading-[0.9] tracking-tighter uppercase mb-8 group-hover:italic transition-all"
            ...
            <div className="flex flex-col flex-1 px-2">
              ...
              <h3>
                <button
                  ...
                  className="text-left before:absolute before:inset-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent rounded-sm text-3xl font-black text-white leading-[1] tracking-tighter mb-4 group-hover:text-accent transition-colors"
